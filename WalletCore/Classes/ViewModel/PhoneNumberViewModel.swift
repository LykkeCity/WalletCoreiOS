...
open class PhoneNumberViewModel {
    ...
    public var isValid: Observable<Bool> {
        return Observable.combineLatest( self.fake.asObservable(), self.phonenumber.asObservable(), resultSelector: {(fake, phonenumber) -> Bool in
...
fileprivate extension ObservableType where Self.E == Void {
    ...
    func mapPhoneNumber(
        ...
        return flatMapLatest {_ in authManager.setPhoneNumber.request(withParams: phone.value)}
            .share()
    }
}
