//
//  LWRxAuthManagerAssetDisclaimersDecline.swift
//  WalletCore
//
...
public class LWRxAuthManagerAssetDisclaimersDecline: NSObject {
    
    public typealias Packet = LWPacketAssetDisclaimersDecline
...
extension LWRxAuthManagerAssetDisclaimersDecline: AuthManagerProtocol {
